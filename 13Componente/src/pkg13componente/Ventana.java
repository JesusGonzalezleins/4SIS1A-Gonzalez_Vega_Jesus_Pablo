...
public class Ventana extends JFrame implements ActionListener {
    ...
    private void componentesPanel1(){
        ...
        panelColor.setBorder(BorderFactory.createBevelBorder(WIDTH));
        
    }
   @Override
   public void actionPerformed(ActionEvent e) {
       //el siguiente codigo va a definir  cuando se presiona el boton entonces 
       //cree una instancia de la clase de JColorChooser y luego el color seleccionado se 
       //se asigne aun objeto a la clase color, por medio  de un metodo showDialog, al cual 
       //se le asigna un titulo y color por defecto
